...
for line in fi:
    ...
    if len(s_content) == 1:
        new_pos_info = edit_pos(pos_info)
    elif len(s_content) == 2:
        new_pos_info1 = edit_pos(s_content[0])
        new_pos_info2 = edit_pos(s_content[1])
        new_pos_info = new_pos_info1+';'+new_pos_info2
    elif len(s_content) == 3:
        new_pos_info1 = edit_pos(s_content[0])
        new_pos_info2 = edit_pos(s_content[1])
        new_pos_info3 = edit_pos(s_content[2])
